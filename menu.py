...
class Menu:
    ...
    def __init__(self, screen):
        ...
        #Buttons
        self.start_button = Button(screen, "Start", (101,123,80), 34, 500, 220)
        self.start_button._draw_element()
        self.trophy_button = Button(screen, "Trophies", (101,123,80), 34, 500, 300)
        self.trophy_button._draw_element()
        self.stats_button = Button(screen, "Stats", (101,123,80), 34, 500, 380)
        self.stats_button._draw_element()
        self.quit_button = Button(screen, "Quit", (101,123,80), 34, 500, 460)
